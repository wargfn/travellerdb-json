TravellerDB cards JSON data
=========

The goal of this repository is to store [TravellerDB](https://travellerdb.com) card data in a format that can be easily updated by multiple people and their changes reviewed.
...
#### Card schema (WORK IN PROGRESS IN DOCUMENTATION)
